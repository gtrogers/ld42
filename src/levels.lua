...
levels[2] = level(
  'assets/stages/opening.png', 6, 'Openings ...', CYAN, 3,
  text['danger'], true)
...
levels[10] = level(
  ...
  1, 'Danger', YELLOW, 11, text['beams'], true)

levels[11] = level(
  'assets/stages/dash_puzzle_medium.png',
  1, 'More danger', YELLOW, 12, text['more_spec'], false)

levels[12] = level(
  'assets/stages/combi_puzzle_1.png',
  1, 'Combination lock', YELLOW, 13)
  
levels[13] = level(
  'assets/stages/combi_puzzle_2.png',
  1, 'Permutations', YELLOW, 14)
...
levels[15] = level(
  ...
  1, 'Dodge and weave', RED, 16, text['understand'], false)
...
levels[20] = level(
  ...
  1.5, 'Fire', RED, 21, text['revelation_1'], false)

levels[21] = level(
  'assets/stages/escape.png',
  1, 'Escape?', RED, 22, text['revelation_2'], false)
